                    ...
                    >
                      ...
                      <div className="hidden lg:block text-left">
                        ...
                        <div className="text-xs text-gray-500 capitalize">
                          <div className="flex items-center">{user.role === "admin" && <Crown className="w-3 h-3 text-red-400 mr-1" />} {user.role === "moderator" && <ShieldCheck className="w-3 h-3 text-orange-400 mr-1" />} {user.role === "user" && <UserStar className="w-3 h-3 text-orange-400 mr-1" />} {user.role}</div>
                        </div>
                      </div>
                      <ChevronDown
