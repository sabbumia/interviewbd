    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="bg-green-100 text-green-700 text-xs px-2 py-1 rounded-lg font-bold border border-green-200">
              {Math.round(
                (analytics.verifiedUsers / analytics.totalUsers) * 100
              )}
              %
            </span>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-xs text-gray-500">engagement activity</p>
          </div>
        </div>
      </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                           <Link href={`/users/${contributor.user.id}`}><span className="font-bold text-xl text-gray-900">
                          ...
                          <p className="text-sm text-gray-600">
                            <div className="flex items-center gap-1">
                              <Mail className="w-4 h-4"/> {contributor.user.email}
                            </div>
                          </p>
                        </div>
                      </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  ...
                  verification{" "}
                  {pendingVerificationsCount === 1 ? "request" : "requests"}{" "}
                  waiting for review.
                </p>
                <p className="text-xs text-orange-600 font-medium">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  ...
                  content {pendingReportsCount === 1 ? "report" : "reports"}{" "}
                  that need attention.
                </p>
                <p className="text-xs text-red-600 font-medium">
