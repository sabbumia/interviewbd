...
import { Heart, CircleStar,ShieldCheck, Crown, Check, ThumbsUp } from "lucide-react";
...
export default function TopLikedUsersSection({
  users,
}: TopLikedUsersSectionProps) {
              ...
              >
                {i === 0 && (
                  <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-pink-400 to-red-500 rounded-bl-full flex items-start justify-end p-2">
                    <CircleStar className="w-10 h-10 text-white " />
                  </div>
                )}
