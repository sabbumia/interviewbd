...
import { TrendingUp, Heart, Award, Users, Bell, BarChart3 } from 'lucide-react';
...
const STAT_STYLES = [
  ...
  { bg: 'bg-violet-50/70 border-violet-100', tile: 'from-violet-500 to-purple-600' },
  { bg: 'bg-orange-50/70 border-orange-100', tile: 'from-orange-500 to-amber-600' },
];
...
export default function ActivityStatistics({
  ...
  const stats = [
    ...
    { icon: Bell, label: 'Pending Requests', value: pendingRequestsCount },
  ];
